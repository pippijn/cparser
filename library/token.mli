...
val token_of_basic_type : Ast.partial_basic_type -> Ctokens.token
...
val token_of_storage_class : Sclass.storage_class -> Ctokens.token
val string_of_storage_class : Sclass.storage_class -> string

val token_of_type_qualifier : Tqual.type_qualifier -> Ctokens.token
val string_of_type_qualifier : Tqual.type_qualifier -> string

val token_of_sue_kind : Ast.sue_kind -> Ctokens.token
val string_of_sue_kind : Ast.sue_kind -> string

val token_of_ternop : Ast.ternary_operator -> Ctokens.token * Ctokens.token
val string_of_ternop : Ast.ternary_operator -> string * string

val token_of_binop : Ast.binary_operator -> Ctokens.token
val string_of_binop : Ast.binary_operator -> string

val token_of_unop : Ast.unary_operator -> Ctokens.token
val string_of_unop : Ast.unary_operator -> string

val token_of_pseudoop : Ast.pseudo_operator -> Ctokens.token
